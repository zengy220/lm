  ...
  <hr>
	<form method="post" action="" name="submitForm" id="submitForm">
	  <div class="form-group">
		商家店名:
			<input type="text" name="name" value="<?php echo ($param["name"]); ?>" style="width:120px;"/>&nbsp;&nbsp;&nbsp;
		商家号: 
			<input type="text" name="business_id" value="<?php echo ($param["business_id"]); ?>" style="width:120px;"/>&nbsp;&nbsp;&nbsp;
		业务员工号:
			<input type="text" name="saleman_id" value="<?php echo ($param["saleman_id"]); ?>" style="width:120px;"/>&nbsp;&nbsp;&nbsp;
		业务员姓名:
			<input type="text" name="real_name" value="<?php echo ($param["real_name"]); ?>" style="width:120px;"/>&nbsp;&nbsp;&nbsp;
		补货时间:
          ...
          <div class="widget-content ">
            <table class="table table-bordered table-striped with-check">
			  ...
			  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><span value="" onclick="pitch_on3( <?php echo ($vo["id"]); ?> )" class="btn btn-success btn-mini" style="width:50px;">查看商品</span></td>
