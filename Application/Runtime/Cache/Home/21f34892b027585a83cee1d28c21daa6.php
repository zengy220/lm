...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span11"><a href="/<?php echo (MODULE_NAME); ?>/Column/add_index/" class="btn btn-success btn" style="float: right;">新增栏目</a>
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            ...
                            <?php if(is_array($collist)): $i = 0; $__LIST__ = $collist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo ($vs["tpcode"]); ?></td>
                                    <td><?php echo ($vs["sort"]); ?></td>
                                    <td><?php echo ($vs["status"]); ?></td>
                                    <td>
                                        <a href="/<?php echo (MODULE_NAME); ?>/Column/edit_index/u/<?php echo ($vs["id"]); ?>/o/edit/" class="btn btn-primary btn-mini">修改</a> |
                                        <a href="/<?php echo (MODULE_NAME); ?>/Column/col_del/u/<?php echo ($vs["id"]); ?>" class="btn btn-danger btn-mini" onclick= "if(confirm('是否确定删除<?php echo ($vs["name"]); ?>!')==false)return  false; ">删除</a>
