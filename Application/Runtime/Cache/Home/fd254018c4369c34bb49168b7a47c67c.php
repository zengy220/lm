        ...
        <div class="row-fluid">
            <div class="span11">
                ...
                <form method="post" action="/<?php echo (MODULE_NAME); ?>/Column/content_list">
                    ...
                    <a href="/<?php echo (MODULE_NAME); ?>/Column/add_content/" class="btn btn-success btn" style="float: right">添加栏目内容</a>
                    </div>
                </form>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            ...
                            <tbody>
                            <?php if(is_array($content_list)): $i = 0; $__LIST__ = $content_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><tr>
