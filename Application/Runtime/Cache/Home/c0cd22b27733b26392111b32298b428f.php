			  ...
			  <form action="/Home/Erweima/edit_code_rule" method="post" class="form-horizontal">
				...
				<div class="control-group control-single">
				  ...
				  <div class="controls" >
					...
					<select style="width:180px;" id="Type_id" name="Type_id">
						...
						<?php if(is_array($ctype)): $i = 0; $__LIST__ = $ctype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["Id"]); ?>" <?php if( $vo["Id"] == $data["Type_id"] ): ?>selected<?php endif; ?> ><?php echo ($vo["Id"]); ?>/<?php echo ($vo["Type_explain"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					...
					<input type="text" value="<?php echo ($data["StartTime"]); ?>" id="StartTime" name="StartTime" placeholder="起始时间" style="width:165px;" onclick="change_picktime()"/> - <input type="text" value="<?php echo ($data["EndTime"]); ?>" id="EndTime" name="EndTime" placeholder="结束时间" style="width:165px;" onclick="change_picktime()"/>
					<label style="display:inline"><input name="TimeUnlimited" id="TimeUnlimited" type="checkbox" value="1" <?php if( $data["StartTime"] == '' ): ?>checked<?php endif; ?> />不限</label>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					...
					<label style="display:inline"><input name="RuleStatus" id="RuleStatus" type="checkbox" value="1" <?php if($data["RuleStatus"] == 0 and $data["RuleStatus"] != null ): ?>checked<?php endif; ?> />关闭规则</label>
				  
				  </div>
				</div>
				
				
				<input type="hidden" name="Id" value="<?php echo ($data["Rule_Id"]); ?>" />
