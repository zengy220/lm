...
<div id="content-header">
  <div id="breadcrumb"> <a href="/<?php echo (MODULE_NAME); ?>/Advertise/ad_list" class="tip-bottom">广告位列表</a> <a href="#" class="current">增加广告位</a> </div>
  <h1>广告位</h1>
</div>
     ...
     <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="/<?php echo (MODULE_NAME); ?>/Advertise/ad_list_add" method="post" class="form-horizontal" onsubmit="return check();">
            <div class="control-group">
              <label class="control-label">名称:</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="请填写名称，不超过10个字" name="name" value="" id="name"  maxlength="11" style="width:200px;"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" placeholder="请填写英文+数字" name="simple_code" id="simple_code" style="width:200px;"/>
              </div>
            </div>
           ...
           <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" placeholder="不超过20个字" name="illustration" id="illustration"style="width:200px;"/>
              </div>
            </div>
...
function check(){
	...
	var simple_code=$("#simple_code").val();
	if(simple_code==""){
		alert("简码不能为空");
		return false;
