...
<div id="content-header">
  <div id="breadcrumb"> <a href="javascript:;" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="/User/user_list" class="current">组织列表</a></div>
  <!-- <h1>用户</h1> -->
</div>
<div class="container-fluid">
  ...
  <div class="row-fluid">
	...
	<div class="span11"><a href="/Home/Company/company_add_html" class="btn btn-success btn">添加组织</a>
          ...
          <div class="widget-content ">
            <table class="table table-bordered table-striped with-check">
			 ...
			 <?php if(is_array($companyInfo)): $i = 0; $__LIST__ = $companyInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				  ...
				  <td><?php if($vo["company_type"] == 1): ?>系统组织<?php else: ?>自定义组织<?php endif; ?></td>
				  <td><?php echo ($vo["company_num"]); ?></td>
				  <td><?php echo (date("Y-m-d",$vo["company_time"])); ?></td>
                  <td><?php if($vo["company_status"] != 1): ?>禁用<?php else: ?>正常<?php endif; ?></td>
				  <td>
					<a href="/Home/Company/company_update_html/company_id/<?php echo ($vo["company_id"]); ?>" class="btn btn-primary btn-mini">修改</a> 
					<?php if( $vo["company_type"] == 2 ): ?><a href="/Home/Company/company_del/company_id/<?php echo ($vo["company_id"]); ?>" class="btn btn-danger btn-mini" onclick= "if(confirm('是否确定删除!')==false)return  false; ">删除</a><?php endif; ?>
				 </td>	  
