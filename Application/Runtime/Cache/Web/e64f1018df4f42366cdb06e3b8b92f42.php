	...
	<div class="box_main fn-clear">
		...
		<div class="box_main_sub2 fn-left">
			...
			<div class="maxbox fl bgf3f5ec insidecon">
			  ...
			  <div style="width:100%;min-height:500px;margin:0 auto;margin-top:10px;font-size:12px;">
			  		<div style="float:left;width:85%;min-height:480px" id="dituContent"></div>
			   ...
			   // var markerArr = [{title:"文渊馆",content:"<a href='http://baidu.com'>湖南农大文渊馆204</a>",point:"113.091076,28.183643",isOpen:1,tel:"123456",address:"湖南省"}
			    ...
			    function addMarker(){
			        for(var i=0;i<markerArr.length;i++){ 
			            ...
			            var type = json.type;
			            var path = "file:///C:/Users/zengyang/Desktop/代码备份/新建文件夹%20(2)/www.hnzyclm.com//Public/map/";
